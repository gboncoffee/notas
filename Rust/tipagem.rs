fn main() {
     ...
     */
    type Kilometers = i32;
    // Perceba que ainda são o mesmo tipo, só tem nome diferente.
    // É possível utilizar com generics inclusive. Ex de std::io:
    type Result<T> = std::result::Result<T, std::io::Error>;
}

/*
 * Há um tipo especial !, que é o empty type. Usado em funções que nunca retornam:
 */
fn never() -> ! { 
    loop {
        continue;
